...
// 配置信息
const config = {
  username: 'Bot-wxt1221', // GitHub repository 所有者，可以是个人或者组织。对应Gitalk配置中的owner
  repo: 'blog', // 储存评论issue的github仓库名，仅需要仓库名字即可。对应 Gitalk配置中的repo
...
const getIsInitByRequest = (id) => {
  const options = {
    headers: {
      'authorization': 'Beare ' + config.token,
